      ...
      <nav class="navbar navbar-expand-lg navbar-dark" data-overlay data-sticky="top">
        <div class="container">
          <a class="navbar-brand fade-page" href="\">
            <img src="https://i.imgur.com/3UcjRE8.png" alt="Keg" style="width: 100px;">
          </a>
            ...
            <div class="py-2 py-lg-0">
              <ul class="navbar-nav">
                <li class="nav-item dropdown">
                  <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown-grid" aria-expanded="false" aria-haspopup="true">Company</a>
          ...
          <div class="collapse navbar-collapse justify-content-end">
            <div class="py-2 py-lg-0">
              <ul class="navbar-nav">
                <li class="nav-item dropdown">
                  <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown-grid" aria-expanded="false" aria-haspopup="true"><img class="icon bg-white" style="height: 22px;" src="assets/img/icons/theme/layout/layout-grid.svg" alt="decoration" data-inject-svg />Products</a>
                  <div class="dropdown-menu row">
                    <div class="col-auto" data-dropdown-content>
                      <div class="dropdown-grid-menu">
                          <a href="https://www.powerup.keg.com.ng" target="_blank" class="dropdown-item fade-page">Power-Up<span class="badge badge-primary ml-2">New</span></a>
                      </div>
                    </div>
                  </div>
                </li>
                <li class="nav-item">
                  ...
                  <a href="#" class="nav-link"><img class="icon bg-white" style="height: 22px;" src="assets/img/icons/theme/general/user.svg" alt="decoration" data-inject-svg />Log in</a>
                  </div>
                </li>
              </ul>
            </div>
            <div data-target="#signup-modal" data-toggle="modal">
            <a href="#" class="btn btn-signup ml-lg-3">Sign up</a>
            </div>
          </div>
        </div>
      </nav>
