          ...
          <div class="collapse navbar-collapse justify-content-end">
            <div class="py-2 py-lg-0">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown-grid" aria-expanded="false" aria-haspopup="true"><img class="icon" src="assets/img/icons/theme/general/user.svg" alt="decoration" data-inject-svg />Log in</a>
                </li>
              </ul>
            </div><a href="https://themes.getbootstrap.com/product/leap-multipurpose-bootstrap-theme/" class="btn btn-signup ml-lg-3">Sign up</a>
